        ...
        private static void Primitives()
        {
            Action<Surface> draw = surface =>
            {
                using (var c = new Context(surface))
                {
                    ...
                    // Stroke:
                    c.LineWidth = 0.1;
                    c.SetSourceColor(new Color(0, 0, 0));
        ...
        private static void AntiAlias()
        {
            Action<Surface> draw = surface =>
            {
                using (var ctx = new Context(surface))
                {
                    ...
                    ctx.SetSourceColor(new Color(0, 0, 0, 1));
                    ...
                    ctx.LineWidth = 8;
                    ctx.SetSourceColor(new Color(1, 0, 0, 1));
        ...
        private static void Demo01()
        {
            Action<Surface> draw = surface =>
            {
                using (var c = new Context(surface))
                {
                    ...
                    c.SetSourceColor(new Color(1, 0, 0, 0.8));
                    c.Fill();

                    c.Rectangle(0, 0.5, 0.5, 0.5);
                    c.SetSourceColor(new Color(0, 1, 0, 0.6));
                    c.Fill();

                    c.Rectangle(0.5, 0, 0.5, 0.5);
                    c.SetSourceColor(new Color(0, 0, 0, 0.4));
                    c.Fill();
                }
            };
        ...
        private static void Hexagon()
        {
            ...
            Action<Surface> draw = surface =>
            {
                using (var c = new Context(surface))
                {
                    ...
                    c.SetSourceColor(new Color(0, 0, 1));
                    ux = 0.1; uy = 0.1;
                    c.DeviceToUserDistance(ref ux, ref uy);
                    c.LineWidth = Math.Max(ux, uy);
